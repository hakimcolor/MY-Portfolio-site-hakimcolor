...
export default function Hero() {
  ...
  return (
    <section ref={heroRef} className="relative flex flex-col-reverse lg:flex-row items-center justify-center px-6 py-16 gap-8 lg:gap-12 w-full mx-auto min-h-[calc(100vh-80px)] overflow-hidden" id="home">
      ...
      >
        <motion.div className="space-y-2" variants={itemVariants}>
          ...
          <motion.h2 
            className="text-xl md:text-2xl font-bold text-slate-300 mt-2 flex items-center gap-2 justify-center md:justify-start flex-wrap"
            variants={itemVariants}
          >
            <motion.span
        ...
        <motion.p 
          ...
          variants={itemVariants}
        >
          I am a passionate and dedicated developer with expertise in building scalable web applications. With a strong foundation in MongoDB, Express, React, and Node.js, I transform ideas into seamless digital experiences. I am also a WordPress Elementor Developer.
        </motion.p>
        ...
        >
          <motion.button 
            onClick={() => {
              ...
              link.href = 'https://drive.google.com/uc?export=download&id=1cva4XZ2QmBKHomJsZ6xjTSQ_F61EhxG_'
        ...
        >
          {[
            ...
            <motion.div
              ...
              whileTap={{ scale: 0.9 }}
            >
              <Link className={`text-slate-400 ${item.color} transition-colors`} href="#">
...
function ProfileImage3D() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative bg-background-dark rounded-full p-2" style={{ transformStyle: 'preserve-3d' }}>
          <motion.div 
          ...
          >
            ...
            <motion.div
              className="absolute inset-0 bg-gradient-to-t from-background-dark/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"
            />
          </motion.div>
        </div>
